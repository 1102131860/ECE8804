...
#          GLOBAL          #
#==========================#
#Set critical range sets the range (in ns) within the critical path delay for which the tool will perform timing 
#optimization. By default, critical range is set to 0.0. In other words, the tool will actually only try to fix 
#all critical paths *with negative slack* that are of delay T_critical and (T_critical - critical_range). For 
#example, if your worst negative slack (WNS) is 3ns, and your critical range is 2, only paths that are of negative 
#slack of 1-3ns will be fixed. Paths at 0.99ns of slack will not be touched. If meeting timing targets is a major 
#priority, you need to set a critical range that is greater than the WNS in your design. 
