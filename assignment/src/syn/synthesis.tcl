...
# Description: This is your top-level synthesis script; the one that calls all the other scripts. Note that the makefile only refers to this file.
# Start your line-by-line review from this file, and whenever you see a "source <filename>", step through that file and return back to this one.
...
# See if you can find where $TOPLEVEL is defined
